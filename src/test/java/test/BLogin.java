...
public class BLogin extends Navegadores {
	...
	public BLogin(WebDriver Drdriver) {
		driver = Drdriver;
	}

	public void Run() {
		WebElement btnUser = driver.findElement(By.xpath("//a[@id='hrefUserIcon']//*[name()='svg']")); // Input user locator
		btnUser.click();
		delay(3);
		WebElement inputUserName = driver.findElement(By.xpath("//input[@name=\"username\"]"));
		inputUserName.sendKeys(user);
